...
namespace Hazelcast.Simulator.Test
{
    ...
    public interface ITestContext
    {
        ...
        ///     <ol>
        ///         <li>
        ///             <see cref="Hazelcast.Simulator.Test.BeforeRunAttribute" />
        ///         </li>
        ///         <li>
        ///             <see cref="Hazelcast.Simulator.Test.TimeStepAttribute" />
        ///         </li>
        ///         <li>
        ///             <see cref="Hazelcast.Simulator.Test.AfterRunAttribute" />
        ///         </li>
        ///     </ol>
        ///     methods to do warmup specific things. For example if a different number of iterations is required during warmup,
        ///     than
        ...
        ///     Using the value inside the timestep method should be done with great care since it can lead to an incorrect warmup
        ///     and
        ...
        /// <summary>
        ///     Stops the run or warmup phase. In most cases an outside duration is passed and the test will run
